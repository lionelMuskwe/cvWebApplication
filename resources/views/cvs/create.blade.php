                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="full-cv-container" style="font-size: 25px;">
                                <form method="POST" action="{{ url('/cvs/')}}" id="createForm">
                                    @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <br>
                                        <input class="col-sm-8" type="text" name="keyProgrammingLanguage" >
                                    </div>
                                    <div class="mb-3">
                                        <span style="font-weight:bold">Education:</span> 
                                        <br>
                                        <input class="col-sm-8" type="text" name="education" >
                                    </div>
                                    <div class="mb-3">
                                        <span style="font-weight:bold">Links:</span> 
                                        <br>
                                        <input class="col-sm-8" type="text" name="URLlinks" >
                                    </div>
                                    <div class="mb-3">
                                        <span style="font-weight:bold">Profile:</span> 
                                        <br>
                                        <textarea class="col-sm-12" type="text" name="profile" rows=10></textarea>
                                    </div>
                                    
                                    <div>
                                        <button id="createFormSubmitButton" type="submit" class="btn btn-success">Create</button>
                                    </div>   
                                </form>
...
<script defer src="{{url('js/form_validation_create.js')}}"></script>
@endsection
