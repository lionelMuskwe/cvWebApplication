        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex justify-content-between" href="{{ url('/') }}">
                    <div class="cv-hub-container">CV HUB</div>
                </a>
                ...
                <div class="d-flex ">
                    @if (!Auth::guest())
                        ...
                        <div style="padding-right:10px">
                            <a href="{{ url('/cvs/create')}}"><button class="btn btn-success">Add New CV</button></a>
                        </div>
                        <div>
                    ...
                    @else
                        @if (Route::has('login'))
                            <a href=" {{url("list")}}">
                                <button class="btn btn-warning" >Continue as a guest</button>
                            </a>
                        @endif
                    @endif
                </div>
